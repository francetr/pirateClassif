...
def retrieveArguments():
    ...
    :return parser: attributes NameSpace of object argParse that contain the two arguments name
...
def orderDetermination(SEQUENCE, POTENTIALCHIMERIC, NOCAT, TE):
    ...
    """
    if (SEQUENCE[5]=="noCat"):
        ###     The order of the TE is not determined : the sequence will be put in NOCAT dictionnary and removed from the TE dictionnary
        NOCAT[SEQUENCE[0]]={"class": SEQUENCE[4], "order": SEQUENCE[5]}
        del TE[SEQUENCE[0]]
